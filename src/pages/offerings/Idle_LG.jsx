  ...
  return (
    <CustomNewCard setScene={setScene}>
      <div className="grow space-y-8">
        <h1 className="text-3xl sm:text-5xl lg:text-7xl capitalize">
        ...
        <div className="text-base sm:text-lg lg:text-xl space-y-4 sm:space-y-8">
          ...
          <h2 className="text-lg sm:text-xl lg:text-3xl">We partner to drive growth and profitability</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl lg:text-3xl">Examples of what we've done</h2>
          <p>
