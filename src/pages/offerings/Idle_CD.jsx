    ...
    <CustomCard setScene={setScene}>
      {/* <CustomCard setScene={setScene}> */}
        <div className="h-[70svh] overflow-y-auto theme-scroll pb-10 z-10 relative">
          <h2 className="text-2xl xl:text-5xl mb-4 sm:mb-10 text-white">Co-Production</h2>

          <h3 className="text-xl text-white font-medium mb-4 sm:mb-5">
            Dedicated cross functional pods tallored for your game needs
          </h3>
          <div className="text-sm xl:text-lg text-white font-light space-y-2 sm:space-y-5 sm:px-5">
            <p>
          ...
          <h3 className="text-xl text-white font-medium mb-4 mt-4 sm:mb-5 sm:mt-10 ">Tag Team with us | Do more or Optimize P&L!</h3>
          <div className="text-sm xl:text-lg text-white font-light space-y-4 sm:space-y-5 sm:px-5">
            <p>
          ...
          <h3 className="text-xl text-white font-medium mb-4 mt-4 sm:mb-5 sm:mt-10">Examples of what we've done</h3>
          <div className="text-sm xl:text-lg text-white font-light space-y-4 sm:space-y-5 sm:px-5">
            <p>
