...
const MeetTeam = () => {
  const info = [
    ...
    },
    {
      ...
      description: `With about 4 years of experience in business development within the GameDev industry, Anton holds a degree in Psychology and Sociology. His passion lies in understanding people and aiding them by identifying bottlenecks and finding ways to improve processes.   Anton has collaborated with a diverse array of companies throughout his career, including industry giants like Netflix, THQ Nordics, Activision Blizzard, Huuuge Games, Stubby Games, Tom Horn Gaming, Team17, Gameloft, Ubisoft, Scopely, Megabit Publishing, and many others.   One of Anton’s notable achievements includes starting with a small team as a test and managing the relationship so effectively that it evolved into a long-lasting partnership of 2 years. This collaboration is ongoing with a AAA game developer and publisher, showcasing Anton’s ability to foster and maintain significant industry relationships.   Anton views the LNG team as a perfect embodiment of unity, transparency, and integrity. To him, the team feels like a family within the company. The squad’s extensive 360-degree vision and expertise in game development, proven by their solid track record with EA games, make LNG an ideal environment for Anton.   Outside of gaming, Anton has a keen interest in history and sociology. He also enjoys shooting at the gun range, racing, and car mechanics, bringing a diverse set of hobbies and skills to his professional life.`,
    ...
    },
    {
      ...
      description: `With over 12 years in the game development industry, Siva has honed his skills as a server-side engineer, tackling complex challenges and pushing the boundaries of what's achievable.   Siva's journey began with curiosity about how games generate revenue. The intricate dance of microtransactions, in-app purchases, ads, and premium game sales fascinated him. Understanding this ecosystem opened his eyes to the industry's potential. As a server-side engineer, he thrives on creative problem-solving and leveraging cutting-edge technology.   Siva's portfolio boasts an impressive lineup of mobile games:   - Monopoly Hotels - Heroes of Dragon Age (for a brief period) - Tetris Blitz - Bejeweled Blitz - Plants vs. Zombies (1, 2, 3) - Plants vs. Zombies Heroes - CnC Mobile - The Sims Mobile - UFC 2     Siva's tech challenges have become cherished memories. Whether scaling solutions for millions of users in Tetris Blitz, Plants vs. Zombies 3, or Heroes of Dragon Age, he consistently stepped outside his comfort zone.   Siva's interests extend beyond gaming. He recently completed a one-year course in corporate and business strategy at IIM Lucknow. His goal? To contribute to LNG's strategic growth and success as part of our leadership team.`,
    ...
    },
    {
      ...
      description: `Sarvanan’s love with games began long before he ever wrote a line of code. As a lifelong gamer, he reveled in the immersive worlds, the adrenaline-pumping challenges, and the sheer joy of exploration. But it wasn’t enough to be a mere player; Sarvanan wanted to shape those worlds, to infuse them with his own brand of magic.   Crafting Gameplay, One Pixel at a Time Game development became his canvas—a place where pixels transformed into playgrounds. Sarvanan’s creative challenges were like intricate puzzles waiting to be solved. Whether it was designing innovative gameplay mechanics or weaving compelling narratives, he thrived on the thrill of creation. And when players immersed themselves in his games, he felt a sense of fulfillment that transcended mere lines of code.   Sarvanan’s portfolio reads like a gamer’s dream. Here are some of the titles he’s left his mark on: Bejeweled: The match-three phenomenon that sparked countless gem-swapping obsessions. Kitchen Scramble: A delightful culinary adventure where players whipped up dishes faster than a chef in a frenzy. Simcity Buildit: The ultimate city-building simulator, where urban planning met player-driven creativity. Real Racing 3: The adrenaline rush of high-speed racing, meticulously crafted for mobile screens.   The Real Racing 3 Revelation But it was at EA Games that Sarvanan faced his greatest challenge. The studio had acquired a new game, and the pressure was on to seamlessly integrate it into the existing ecosystem. The clock was ticking, but Sarvanan’s team didn’t flinch. They orchestrated a flawless transition, releasing new content without disrupting players. How? By listening to player feedback, iterating tirelessly, and exceeding expectations. It was a lesson in collaboration and the power of player-centric development.`,
...
const Card = ({ info }) => {
  ...
  return (
    <div className="w-full flex flex-wrap-reverse lg:flex-nowrap justify-center lg:justify-between items-start lg:items-center mx-auto">
    <div className="text-lg lg:basis-1/2">{description}</div>
