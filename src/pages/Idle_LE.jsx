...
const Idle_LE = ({ setScene, style }) => {
  return (
    ...
    <div className="flex flex-col justify-center items-center md:items-start grow w-full gap-6 sm:gap-12 md:gap-14 lg:gap-20">
             <h1 className="text-xl sm:text-5xl lg:text-5xl capitalize z-20 w-fit font-bold mx-auto">Our Leadership Experience</h1>
...
const FeaturesCard= ({heading, children})=>{
 ...
 <div className="text-xl sm:text-3xl lg:text-4xl z-20 w-fit text-center font-semibold ">{heading}+</div>
