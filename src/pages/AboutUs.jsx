  ...
  return (
    <CustomNewCard setScene={setScene}>
        <div className="flex flex-col justify-center items-center md:items-start grow w-full md:max-w-[80%] gap-10">
          <h1 className="text-3xl sm:text-5xl lg:text-5xl capitalize z-20 w-fit ">Company history</h1>
          <p className="text-lg sm:text-xl lg:text-xl z-20 w-fit text-center md:text-left ">
