  ...
  return (
   <CustomNewCard setScene={setScene}>
     <div className="flex flex-col justify-center items-center md:items-start grow w-full gap-6 sm:gap-12 md:gap-14 lg:gap-20">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl capitalize z-20 mx-auto font-bold ">Our Philosophy</h1>
...
<h2 className="text-xl sm:text-3xl lg:text-4xl font-semibold text-center">Process</h2>
          ...
          <p className=" sm:text-xl lg:text-2xl text-center">We truly believe that creating fun, unforgettable player and player experiences are what great timeless and profitable.</p>
